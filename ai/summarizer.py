...
class OSINTSummarizer:
    ...
    async def generate_summary(self, investigation: Dict[str, Any]) -> str:
        """
    ...
    async def _generate_ai_summary(self, investigation: Dict[str, Any]) -> str:
        """
    ...
    def _generate_heuristic_summary(self, investigation: Dict[str, Any]) -> str:
        """
    ...
    def _extract_key_findings(self, findings: Dict[str, Any]) -> Dict[str, Any]:
        """
