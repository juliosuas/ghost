...
class DarkWebModule:
    ...
    async def _search_ahmia(self, query: str) -> Dict[str, Any]:
        """
    ...
    async def _check_breach_databases(self, target: str) -> Dict[str, Any]:
        """
    ...
    async def _check_paste_sites(self, target: str) -> Dict[str, Any]:
        """
    ...
    async def _check_dehashed(self, target: str) -> Dict[str, Any]:
        """
