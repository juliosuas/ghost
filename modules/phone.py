...
class PhoneModule:
    ...
    def __init__(self, config: Config):
        """Initialize the PhoneModule instance.
    ...
    async def run(self, target: str, input_type: str = "phone") -> Dict[str, Any]:
        ...
        Args:
            target (str): The target phone number.
            input_type (str, optional): The type of input. Defaults to "phone".

        Returns:
            Dict[str, Any]: The results of the OSINT checks.
        """
    ...
    async def _parse_and_validate(self, number: str) -> Dict[str, Any]:
    ...
    async def _check_spam_databases(self, number: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: The results of the spam database checks.
        """
        reports = []
    ...
    async def _check_social_media(self, number: str) -> Dict[str, Any]:
        ...
        Returns:
            Dict[str, Any]: The results of the social media checks.
        """
        linked_accounts = []
