...
class ImageModule:
    ...
    async def _load_image(self, target: str) -> Optional[bytes]:
    ...
    async def _extract_exif(self, target: str, image_data: bytes) -> Dict[str, Any]:
        """Extract EXIF metadata from image."""
        try:
            tags = process_file(io.BytesIO(image_data), details=False)
    ...
    async def _detect_faces(self, image_data: bytes) -> Dict[str, Any]:
        ...
        try:
            ...
            face_locations = face_locations(img_array)
