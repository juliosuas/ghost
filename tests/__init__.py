...
class TestGhost(unittest.TestCase):
    ...
    def test_open_with_options(self, mock_open):
        ...
        mock_open.return_value.__enter__.return_value.read.return_value = "test"
        self.assertEqual(
            self.ghost.open(get_test_url(), options={"timeout": 10}).read(), "test"
        )
    ...
    def test_open_with_user_agent(self, mock_open):
        ...
        mock_open.return_value.__enter__.return_value.read.return_value = "test"
        self.assertEqual(
            self.ghost.open(get_test_url(), user_agent="test_user_agent").read(), "test"
        )
    ...
    def test_get_with_options(self):
        ...
        """
        self.assertEqual(
            self.ghost.get(get_test_url(), options={"timeout": 10}).status_code, 200
        )
    ...
    def test_get_with_user_agent(self):
        ...
        """
        self.assertEqual(
            self.ghost.get(get_test_url(), user_agent="test_user_agent").status_code,
            200,
        )
    ...
    def test_post_with_options(self):
        ...
        """
        self.assertEqual(
            self.ghost.post(get_test_url(), options={"timeout": 10}).status_code, 200
        )
    ...
    def test_post_with_user_agent(self):
        ...
        """
        self.assertEqual(
            self.ghost.post(get_test_url(), user_agent="test_user_agent").status_code,
            200,
        )
    ...
    def test_head_with_options(self):
        ...
        """
        self.assertEqual(
            self.ghost.head(get_test_url(), options={"timeout": 10}).status_code, 200
        )
    ...
    def test_head_with_user_agent(self):
        ...
        """
        self.assertEqual(
            self.ghost.head(get_test_url(), user_agent="test_user_agent").status_code,
            200,
        )
    ...
    def test_delete_with_options(self):
        ...
        """
        self.assertEqual(
            self.ghost.delete(get_test_url(), options={"timeout": 10}).status_code, 200
        )
    ...
    def test_delete_with_user_agent(self):
        ...
        """
        self.assertEqual(
            self.ghost.delete(get_test_url(), user_agent="test_user_agent").status_code,
            200,
        )
